...
public class BookDetailView {
     ...
     * @param book
     */
    public BookDetailView(Library library, Book book) {
        copyListModel = new CopyListModel(library.getCopiesOfBook(book));
        initialize();
        frmBuchDetailansicht.setVisible(true);
        frmBuchDetailansicht.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);

        updateValues(book);
    }

    private void updateValues(Book book) {
    ...
    private void initialize() {
        ...
        frmBuchDetailansicht.getContentPane().add(panel, BorderLayout.NORTH);
        ...
        frmBuchDetailansicht.getContentPane().add(panel_1, BorderLayout.CENTER);
